...
//			  : 소프트웨어 어플리케이션 간에 상호 작용한느데 사용되는 일련의 규칙과 도구를 제공하는 인터페이스
//			  ==> 쉽게 말해 개발자가 다른 소프트웨어의 기능을 활용하도록 하는 중요한 개념
//			  
//  두 소프트웨어 시스템 간의 상호 작용을 위한 규약이나 프로토콜을 제공
//  
// Ex)
// 데이터의 교환, 서비스의 호출, 라이브러리 함수의 사용 등
//
// 2. API Class : 자바 플랫폼에서 제공하는 다양한 라이브러리 및 클래스들을 의미
// 이러한 클래스들은 JAVA API 의 일부로 제공됨
// 따라서 JAVA 언어를 사용하여 소프트위어를 개발하는 데 도움을 주는 다양한 기능을 제공
// 
// 1. Java.lang 패키지 : 기본 데이터 유형, 예외 처리 등의 핵심 클래스들
// 2. Java.util 페키지 : 컬렉션 프레임워크, 날짜 및 시간 관련 클래스 등
// 3. Java.lo 패키지 : 입출력 작업을 위한 클래스
