...
//			sum += i; // sum = sum + i;
//			i++; // 후치 연산
//		}System.out.println("while 종료 후 i의 값 = "+i);System.out.println("1부터 10까지의 합 = "+sum);

		// N(입력한 수)는 사용자로부터 입력받아야하는 수 // 12
		// 1부터 N(입력한 수)까지의 합 구하기

//		Scanner sc = new Scanner(System.in);System.out.println("정수 하나를 입력해주세요 >>");
//		int num = sc.nextInt();
	//
//		int i = 1;
...
//			sum += i;
//			i++;
//		}System.out.println("1부터 "+num+"까지의 합 : "+sum);System.out.printf("1부터 %d까지의 합 : %d",num,sum);
	//
...
//		// ( n = 5, m = 3을 넣어도 3부터 5까지의 합은 12)
	//
//		Scanner sc = new Scanner(System.in);System.out.println("첫번째 정수를 입력해주세요 >>> ");
//		int n = sc.nextInt();
//		// 탈출용 변수이자, 백업 변수
//		int backup n=n;
	//
...
//		Scanner sc = new Scanner(System.in);System.out.println("정수를 하나 입력해 주세요 >>> ");
//		int x = sc.nextInt(); // 10
//		int i = 1; // 누적 합 저장 변수
//		int backup x=x;
//		int sum = 0;while(i<=x)
