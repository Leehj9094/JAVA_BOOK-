...
public class C05Datemain {				// 나중에 외부 실기칠 때 외워야함 꼭!!!!!!!!! 
...
//		System.out.println(d1.getYear()+1900);	// 125 -> +1900을 더해주면 제대로 나옴 
//		System.out.println(d1.getMonth()+1);	// 0월부터 나오기 때문에 +1을 더해서 해줘야 함
