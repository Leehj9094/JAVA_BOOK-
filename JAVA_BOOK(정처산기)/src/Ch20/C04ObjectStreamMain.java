...
class Board implements Serializable { // 상속관계를 줘야 에러? 가 안뜸(직렬화)

	private static final long serialVersionUID = 1L; // 직렬화를 사용하기 때문에 long을 써야 나중에 문제가 덜생김?
...
//		ObjectOutputStream oout = new ObjectOutputStream(out); // 안전하게
