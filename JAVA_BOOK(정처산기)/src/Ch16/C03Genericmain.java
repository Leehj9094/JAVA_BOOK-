...
//class Couple<X, Y>{
	class Couple<X extends Person, Y>{
	private X member1;
	private Y member2;
	// 생성자
...
public class C03Genericmain {
	...
	public static void main(String[] args) {
		...
		Couple<Man,Man> couple2 = new Couple<Man,Man>(new Man("홍길동1","30","대구"), new Man("홍길동","25","인천"));
		System.out.println("couple2 : " + couple2);
		
//		Couple<Double,Integer> couple3 = new Couple<Double, Integer>(100.4,200);
